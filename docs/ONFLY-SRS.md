...
| ID | Proposal | Reason |
|---|---|---|
| D-18 | Record layouts generated from a single master definition (IR-COM-01) | Stops the COBOL, C and Python layouts from drifting; handles MVT COPY limitations. Presented during the rounds without objection; owner to confirm. |
...
| TBD-06 | Standard duration, maximum duration, seeds per rate (proposed 30) | FR-SIM-06, NFR-PERF-01, Section 6.4 | Gate G3 |
...
| TBD-11 | PRNG algorithm confirmation | NR-13 | Phase B |
...
| TBD-16 | SoftFloat NaN specialization | NR-02 | Gate G1 |
