...
on silence. Items 2, 3, 4, 5, 6, 10, 11, 13, 14, 16 to 21, 23, 30, 31, 32, 36 and 42 are closed, items 8 and 29 are answered for slices C and D, item 7 is answered for slice E only (D-554), and item 9 is deferred; their rows name the D-row.
