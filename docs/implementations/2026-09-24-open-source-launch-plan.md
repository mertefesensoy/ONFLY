...
| File | Change |
|---|---|
| `docs/plan/2026-09-24-open-source-launch.md` | New: the launch and outreach plan, proposal P-40 (provisional number), approved by the owner (O-5) and published in full at the owner's choice (O-6). |
...
- **Scrub forward only (O-1).** The owner chose this over a fresh public
  ...
  use it.
- **Rewrite the summary as a public overview (O-2)**, written new from the
  claims register. The old text is stale and partly false, so it is not
  edited.
- **Neutral wording plus a decision row (O-3).** The critics added one
...
- `docs/plan/2026-09-24-open-source-launch.md`: the plan (P-40)
